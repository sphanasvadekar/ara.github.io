...
if(isset($_POST["getProduct"])){
	...
	if(mysqli_num_rows($run_query) > 0){
		while($row = mysqli_fetch_array($run_query)){
			...
			$pro_deposite = $row['product_deposite'];
...
if (isset($_POST["Common"])) {
	...
	if (isset($_SESSION["uid"])) {
		...
		$sql = "SELECT a.product_id,a.product_title,a.product_price,a.product_deposite,a.product_image,b.id,b.qty FROM products a,cart b WHERE a.product_id=b.p_id AND b.ip_add='$ip_add' AND b.user_id < 0";
	}
	$query = mysqli_query($con,$sql);
	if (isset($_POST["getCartItem"])) {
		...
		if (mysqli_num_rows($query) > 0) {
			...
			while ($row=mysqli_fetch_array($query)) {
				...
				$product_deposite = $row["product_deposite"];
				...
				echo '
					<div class="row">
						...
						<div class="col-md-3">'.$product_deposite.'</div>
					</div>';
				...
				while ($row=mysqli_fetch_array($query)) {
					...
					echo 
						'<div class="row">
								...
								<div class="col-md-2"><input type="text" class="form-control price" value="'.$product_deposite.'" readonly="readonly"></div>
								<div class="col-md-2"><input type="text" class="form-control total" value="'.$product_deposite.'" readonly="readonly"></div>
							</div>';
				}
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							$x=0;
							$sql = "SELECT a.product_id,a.product_title,a.product_price,a.product_deposite,a.product_image,b.id,b.qty FROM products a,cart b WHERE a.product_id=b.p_id AND b.user_id='$_SESSION[uid]'";
							$query = mysqli_query($con,$sql);
							while($row=mysqli_fetch_array($query)){
								$x++;
								echo  	
									'<input type="hidden" name="item_name_'.$x.'" value="'.$row["product_title"].'">
								     ...
								     <input type="hidden" name="Deposite_'.$x.'" value="'.$row["product_deposite"].'">
