  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="add-product-form" enctype="multipart/form-data" action="products.php">
        	<div class="row">
        		<div class="col-12">
            ...
            <div class="col-12">
              <div class="form-group">
                ...
                <div class="col-12">
              <div class="form-group">
                <label>Product Deposite</label>
                <input type="number" name="product_deposite" class="form-control" placeholder="Enter Product Deposite">
		        	</div>
        		</div>
        		<div class="col-12">
        			<div class="form-group">
        		...
        		<div class="col-12">
        			<button type="Submit" class="btn btn-primary add-product" data-dismiss="modal">Add Product</button>
        		</div>
        	</div>
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="form-group">
                ...
                <div class="col-12">
              <div class="form-group">
                <label>Product Deposte Amount</label>
                <input type="number" name="e_product_deposite" class="form-control" placeholder="Enter Product Deposite">
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
